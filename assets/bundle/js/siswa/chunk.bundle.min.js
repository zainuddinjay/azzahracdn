...
angular.module('cfp.loadingBar', [])
  .provider('cfpLoadingBar', function() {
    ...
    this.spinnerTemplate = '<div id="loading-bar-spinner"><center><div class="spinner-icon"></div><span id="spinner-balon">Silahkan Tunggu</span></center></div>';
