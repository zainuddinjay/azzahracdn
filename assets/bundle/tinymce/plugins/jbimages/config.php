...
| -------------------------------------------------------------------*/
	...
	$config['img_path'] = '/tinyimage/images'; // Relative to domain name
	$config['upload_path'] = $_SERVER['DOCUMENT_ROOT'] ."/". 'tinyimage/images'; // Physical path. [Usually works fine like this]
